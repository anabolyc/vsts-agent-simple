...
param(
  ...
  if ([IntPtr]::Size -ne 4) {
    $fileFullPathNoRedirection = $zipfileFullPath -ireplace ([System.Text.RegularExpressions.Regex]::Escape($ENV:System)),(Join-Path $Env:SystemRoot 'SysNative')
    $destinationNoRedirection = $destination -ireplace ([System.Text.RegularExpressions.Regex]::Escape($ENV:System)),(Join-Path $Env:SystemRoot 'SysNative')
  } else {
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCvu8edAZBRHOTJ
# 7c/uoVdJezVXPYodp4FEzhuoL3hLEqCCF7EwggUwMIIEGKADAgECAhAECRgbX9W7
...
# NwIBFTAvBgkqhkiG9w0BCQQxIgQgkERvmO9AR/DzPDIxIF+ZIkRK1BVVQJxpnNkt
# tD1kaccwDQYJKoZIhvcNAQEBBQAEggEAPqa2H4QeYDpPfe+xAEcHO8lZMAlQTnx5
# ejGV4fGKZ89d56JVl6cRMQpYHRTKmgE5fi4M8Pdgu7dsskSu4FVu/bfjXTr2svIL
# VhVLz3QEi4eBDLsprKveHwqUkOk83JgKKFQrui6zRKBVCd/OU/Sit3T7O32uY4Mf
# ubHvtSj7q0OH9PpgQPLUlfyk4h8Fa0oa2Lvt2rU+3TDmkpRHm1cdDkttCcqjkc8Y
# U5cVep0qDOsFIqCUfmnhDAvNREv/pf3ASbVSVsphuQR7NNWDJcjp+QFYbzzhptEw
# ADHYa/czlYy95VYVMUIMGadJkLE5GKS5A4zXl10bxA9Fs7Sgmi81paGCAg8wggIL
...
# CQUxDxcNMTgwNTA0MjMwOTAzWjAjBgkqhkiG9w0BCQQxFgQUKcZv9t7WG+XgB8Vo
# 5DI2bPTIM+swDQYJKoZIhvcNAQEBBQAEggEAMddUT2mutupGY6CCBDX8K8gxCqQG
# 338FflsfQwFwyrA/P0l/z+yy/6xN4GR5s+PyNIW4EyT0CMIXbDk3kkgERX37f+3f
# NV1DWD8cAG8oLsvGFxdRI2KTd8zHqAOJmBR5mpAwoVHTxPRUwtK+oc4H8sAeG+wc
# tkF88RheVuFRfEXsVPMi7Ms+6mbPI8KIzTGLRTg8E1D6tNj/6oIQHps3T5kyW0hw
# ogbn6vRtYE5i4x1SNYcAYcDaFx/AHoVRSMCffm3PbQKFB5fTL0WlQFNFrnH2BBin
# GqqBU0Olb+QEZ1kD+2xYdQSGmfEo55SgAczL/REOs6WohJhLCkUI/l+ahg==
